...
import com.example.footymastermind.databinding.ActivityForgotPasswordBinding
        ...
        forgotBinding.buttonReset.setOnClickListener{
            ...
            auth.sendPasswordResetEmail(userEmail).addOnCompleteListener { task ->
                if (task.isSuccessful){
                    Toast.makeText(applicationContext, "We sent a password reset mail to your email adress", Toast.LENGTH_SHORT).show()
                    finish()
                }else{
